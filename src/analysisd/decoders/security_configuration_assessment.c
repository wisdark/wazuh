...
int DecodeSCA(Eventinfo *lf, int *socket)
{
    ...
    if(type) {
        ...
        if (strcmp(type->valuestring,"check") == 0){
            ...
            mdebug1("Got check event: '%s'",cJSON_PrintUnformatted(json_event));
            ...
            mdebug1("Got summary event: '%s'",cJSON_PrintUnformatted(json_event));
            ...
            mdebug1("Got policies event: '%s'",cJSON_PrintUnformatted(json_event));
            ...
            mdebug1("Got dump finished event: '%s'",cJSON_PrintUnformatted(json_event));
